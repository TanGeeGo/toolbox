...
"""
# ----------------------------------------------------
# functions for parse the option
# ----------------------------------------------------
"""
...
def parse(opt_path, is_train=True):
    ...
    for phase, dataset in opt['datasets'].items():
        ...
        if 'dataroot_IP' in dataset and dataset['dataroot_IP'] is not None:
            dataset['dataroot_IP'] = os.path.expanduser(dataset['dataroot_IP'])
...
"""
# ----------------------------------------------------
# convert the configuration into files
# ----------------------------------------------------
"""
